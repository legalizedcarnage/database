...
<html>
    <head>
        ...
        <script src="stylesheet" href="../../web files/jquery-3.3.1.min.js">
        </script>
    ...
    <br>
        ...
        <div class="row row2">
            <div class="col-sm-2">
                ...
                <h1 style="margin:0px;"><span class="largenav">  <a href="./">
            ...
            <div class="flipkart-navbar-search smallsearch col-sm-7 col-xs-11">
                <div class="row">
                    ...
                    <input class="flipkart-navbar-input col-xs-11" type="" placeholder="Search for Games, Consoles, and more" name="search">
                    <?php 
                    if(isset($_GET['cat'])) {
            ...
            <div class="cart largenav col-sm-3">
                <a class="cart-button" href='checkout.php'>
                    <svg class="cart-svg " width="16 " height="16 " viewBox="0 0 16 16 ">
                        <path d="M15.32 2.405H4.887C3 2.405 2.46.805 2.46.805L2.257.21C2.208.085 2.083 0 1.946 0H.336C.1 0-.064.24.024.46l.644 1.945L3.11 9.767c.047.137.175.23.32.23h8.418l-.493 1.958H3.768l.002.003c-.017 0-.033-.003-.05-.003-1.06 0-1.92.86-1.92 1.92s.86 1.92 1.92 1.92c.99 0 1.805-.75 1.91-1.712l5.55.076c.12.922.91 1.636 1.867 1.636 1.04 0 1.885-.844 1.885-1.885 0-.866-.584-1.593-1.38-1.814l2.423-8.832c.12-.433-.206-.86-.655-.86 " fill="#fff "></path>
                    </svg> Cart
                    <span class="item-number "><?php if(isset($_SESSION['cart'])){echo sizeof($_SESSION['cart']);}else {echo "0";}?></span>
                </a>
                <a class="cart-button" href='account.php'>
                    My Account
        ...
        <div class="row row1">
            <ul class=" ">
                <a class="links" href="./"><li style="background:black;border:1px black solid" class="upper-links">All</li></a>
                <a class="links" href="./index.php?cat=xbox"><li style="background:black;border:1px black solid"class="upper-links">Xbox</li></a>
                <a class="links" href="./index.php?cat=playstation"><li style="background:black;border:1px black solid"class="upper-links">Playstation</li></a>
                <a class="links" href="./index.php?cat=switch"><li style="background:black;border:1px black solid"class="upper-links">Switch</li></a>
